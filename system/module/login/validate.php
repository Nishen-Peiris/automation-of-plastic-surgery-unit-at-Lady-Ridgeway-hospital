...
if ($count != 0) {
    ...
    $_SESSION['psc_fname'] = $rowuser['fname'];
    $_SESSION['psc_lname'] = $rowuser['lname'];
    $_SESSION['psc_email'] = $rowuser['email'];
    $_SESSION['psc_user_role_id'] = $rowuser['user_role_id'];
    $_SESSION['psc_user_role_name'] = $rowuser['user_role_name'];
    $_SESSION['psc_user_id'] = $rowuser['user_id'];
    $_SESSION['psc_password'] = $rowuser['password'];
    $_SESSION['psc_username'] = $rowuser['username'];

    //Session ID for user
    $_SESSION['psc_session_id'] = $rowuser['user_id'] . "_" . $t;

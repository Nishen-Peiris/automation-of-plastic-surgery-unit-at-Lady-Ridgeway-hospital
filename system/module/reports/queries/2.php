...
$sql = "SELECT clinic_no_type, clinic_no, first_contact_date, patient_name, DoB, address, gender, referred_by_hospital, hospital_district, referred_by_person FROM permanent_registration WHERE first_contact_date LIKE '$year%'";
$result = $conn->query($sql);

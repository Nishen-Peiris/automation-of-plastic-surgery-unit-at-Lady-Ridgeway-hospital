...
<div id="main">
    ...
    <div id="contents">
        ...
        <div>
            ...
            <form name="PreSurgeryInformationEdit" method="post" action="editRecord.php"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1 col-sm-1 col-md-1">
                        <input id="mdcc" type="radio" name="clinic_no_type" value="MDCC" <?php echo ($clinic_no_type == "MDCC") ? "checked=\"checked\"" : ""; ?>/> MDCC
                        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
                        <div class="">
                            <input id="psc" type="radio" name="clinic_no_type" value="PSC"  <?php echo ($clinic_no_type == "PSC") ? "checked=\"checked\"" : ""; ?>/> PSC
                            <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3 col-md-3">
                <select id="reason_for_surgery" name="reason_for_surgery" class="btn dropdown-toggle">
                    <option value="Primary"  <?php echo ($reason_for_surgery == "Primary") ? "selected=\"selected\"" : ""; ?>> Primary</option>
                    <option value="Secondary" <?php echo ($reason_for_surgery == "Secondary") ? "selected=\"selected\"" : ""; ?>> Secondary</option>
                </select>
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                Surgery Date :
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-3 col-md-3">&nbsp;</div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="part_of_the_body_head" <?php echo ($part_of_the_body_head == "1") ? "checked=\"checked\"" : ""; ?> name="part_of_the_body_head" value="1" /> Head
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="side_of_the_body_left" <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> name="side_of_the_body_left" value="1"/> Left
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="tissue_plane_skin"  <?php echo ($tissue_plane_skin == "1") ? "checked=\"checked\"" : ""; ?> name="tissue_plane_skin" value="1"/> Skin
            </div>
            <div class="col-lg-3 col-sm-3 col-md-3">&nbsp;</div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="part_of_the_body_upper_limb" name="part_of_the_body_upper_limb"
                    <?php echo ($part_of_the_body_upper_limb == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Upper Limb
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="side_of_the_body_right"  <?php echo ($side_of_the_body_right == "1") ? "checked=\"checked\"" : ""; ?> name="side_of_the_body_right" value="1"/> Right
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="tissue_plane_muscle_tendons" name="tissue_plane_muscle_tendons"
                    <?php echo ($tissue_plane_muscle_tendons == "1") ? "checked=\"checked\"" : ""; ?>   value="1"/> Muscles/Tendons
            </div>
            <div class="col-lg-3 col-sm-3 col-md-3">&nbsp;</div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="tissue_plane_arteries"  <?php echo ($tissue_plane_arteries == "1") ? "checked=\"checked\"" : ""; ?> name="tissue_plane_arteries" value="1"/>
                Arteries
            </div>
            <div class="col-lg-3 col-sm-3 col-md-3">&nbsp;</div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="part_of_the_body_lower_limb" name="part_of_the_body_lower_limb"
                    <?php echo ($part_of_the_body_lower_limb == "1") ? "checked=\"checked\"" : ""; ?>    value="1"/> Lower Limb
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                &nbsp;
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="tissue_plane_veins"  <?php echo ($tissue_plane_veins == "1") ? "checked=\"checked\"" : ""; ?> name="tissue_plane_veins" value="1"/> Veins
            </div>
            <div class="col-lg-3 col-sm-3 col-md-3">&nbsp;</div>
            <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
            <div class="row">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2">
                    <input type="checkbox" id="tissue_plane_nerves" <?php echo ($tissue_plane_nerves == "1") ? "checked=\"checked\"" : ""; ?> name="tissue_plane_nerves" value="1"/> Nerves
                </div>
                <div class="col-lg-3 col-sm-3 col-md-3">&nbsp;</div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="head_eye"  <?php echo ($head_eye == "1") ? "checked=\"checked\"" : ""; ?> name="head_eye" value="1"/> Eye
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="upper_limb_arm"  <?php echo ($upper_limb_arm == "1") ? "checked=\"checked\"" : ""; ?> name="upper_limb_arm" value="1"/> Arm
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="trunk_chest"  <?php echo ($trunk_chest == "1") ? "checked=\"checked\"" : ""; ?> name="trunk_chest" value="1"/> Chest
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="lower_limb_thigh"  <?php echo ($lower_limb_thigh == "1") ? "checked=\"checked\"" : ""; ?> name="lower_limb_thigh" value="1"/> Thigh
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="head_nose" name="head_nose"  <?php echo ($head_nose == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Nose
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="upper_limb_forearm"  <?php echo ($upper_limb_forearm == "1") ? "checked=\"checked\"" : ""; ?> name="upper_limb_forearm" value="1"/> Forearm
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="trunk_abdomen"  <?php echo ($trunk_abdomen == "1") ? "checked=\"checked\"" : ""; ?> name="trunk_abdomen" value="1"/> Abdomen
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="lower_limb_leg"  <?php echo ($lower_limb_leg == "1") ? "checked=\"checked\"" : ""; ?> name="lower_limb_leg" value="1"/> Leg
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="head_ear"  <?php echo ($head_ear == "1") ? "checked=\"checked\"" : ""; ?> name="head_ear" value="1"/> Ear
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="upper_limb_hand"  <?php echo ($upper_limb_hand == "1") ? "checked=\"checked\"" : ""; ?> name="upper_limb_hand" value="1"/> Hand
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="trunk_back"  <?php echo ($trunk_back == "1") ? "checked=\"checked\"" : ""; ?> name="trunk_back" value="1"/> Back

            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="lower_limb_foot"  <?php echo ($lower_limb_foot == "1") ? "checked=\"checked\"" : ""; ?> name="lower_limb_foot" value="1"/> Foot
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="head_mouth"  <?php echo ($head_mouth == "1") ? "checked=\"checked\"" : ""; ?> name="head_mouth" value="1"/> Mouth
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="upper_limb_axilla" <?php echo ($upper_limb_axilla == "1") ? "checked=\"checked\"" : ""; ?> name="upper_limb_axilla"  value="1"/> Axilla
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2"></div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="lower_limb_genitalia" <?php echo ($lower_limb_genitalia == "1") ? "checked=\"checked\"" : ""; ?> name="lower_limb_genitalia" value="1"/> Genitalia
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="head_face"  <?php echo ($head_face == "1") ? "checked=\"checked\"" : ""; ?> name="head_face" value="1"/> Face
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox"  id="upper_limb_elbow" name="upper_limb_elbow" <?php echo ($upper_limb_elbow == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Elbow
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2"></div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="lower_limb_knee" name="lower_limb_knee"  <?php echo ($lower_limb_knee == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Knee
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2"></div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="upper_limb_wrist" name="upper_limb_wrist"  <?php echo ($upper_limb_wrist == "1") ? "checked=\"checked\"" : ""; ?>  value="1"/> Wrist
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2"></div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="lower_limb_ankle" name="lower_limb_ankle" <?php echo ($lower_limb_ankle == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Ankle
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2"></div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="chk1" name="upper_limb_fingers"  <?php echo ($upper_limb_fingers == "1") ? "checked=\"checked\"" : ""; ?>  value="1"/> Fingers
                <ul id="list1">
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Thumb</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Index</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Middle</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Ring</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Little</li>
                </ul>
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2"></div>
            <div class="col-lg-2 col-sm-2 col-md-2">
                <input type="checkbox" id="chk2" name="lower_limb_toes" <?php echo ($lower_limb_toes == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> Toes
                <div class="col-lg-2 col-sm-2 col-md-2">&nbsp;</div>
                <ul id="list2">
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> 1</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> 2</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> 3</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> 4</li>
                    <li><input type="checkbox"  <?php echo ($side_of_the_body_left == "1") ? "checked=\"checked\"" : ""; ?> value="1"/> 5</li>
                </ul>
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12"> &nbsp;</div>

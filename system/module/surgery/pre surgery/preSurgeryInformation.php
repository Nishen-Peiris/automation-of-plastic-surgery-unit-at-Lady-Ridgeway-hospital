                    ...
                    <table border="1">
                        ...
                        while ($row = $pre_surgery_data->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    echo "<a href=\"editRecord.php?id=$id\">Edit | </a>";
                                    echo ($row["status"] == "Active") ? "<a href=\"activateRecord.php?id=$id\">Activate</a>" : "<a href=\"deactivateRecord.php?id=$id\">Deactivate</a>";
                                    ?>
                                </td>
                            </tr>
                            <?php

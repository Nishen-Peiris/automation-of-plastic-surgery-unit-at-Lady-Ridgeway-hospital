...
$sql = "SELECT id, clinic_no_type, clinic_no, first_contact_date, patient_name, DoB, address, gender, referred_by_hospital, hospital_district, referred_by_person FROM permanent_registration LIMIT $offset, $rec_limit";
